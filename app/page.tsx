      ...
      <section className="py-12 px-4 bg-gray-50 border-y border-gray-200">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <a href="https://www.newsioo.com/" target="_blank" rel="noopener noreferrer" className="flex gap-4 items-start p-5 rounded-xl border border-gray-200 bg-white hover:border-blue-400 hover:bg-blue-50 transition-colors no-underline">
              <span className="text-3xl">🌍</span>
              <div>
                <p className="font-bold text-gray-900 text-sm mb-1">일본·미국·중국 직구 관세 계산기</p>
                <p className="text-xs text-gray-500 leading-relaxed">엔화·위안화·유로 입력 시 실시간 환율로 관세·부가세 자동 계산. 면세 한도 초과 여부 즉시 확인</p>
              </div>
            </a>
          </div>
        </div>
